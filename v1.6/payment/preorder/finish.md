...
> 阅读本文之前请仔细阅读[手机支付控件 - 预授权完成](https://open.unionpay.com/tjweb/acproduct/APIList?acpAPIId=771&apiservId=450&version=V2.2&bussType=0)
...
$params = [
    ...
    'txnAmt' => '1',
    'origQryId' => date('YmdHis')
];

$res = $app->preorder->finish($params);
...
| 原交易查询流水号 | origQryId    | AN21           | 无     | M-必填       | 原始预授权交易的queryId                                      |
