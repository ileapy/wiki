...
> 阅读本文之前请仔细阅读[手机支付控件 - 预授权完成撤销](https://open.unionpay.com/tjweb/acproduct/APIList?acpAPIId=772&apiservId=450&version=V2.2&bussType=0)
...
$res = $app->preorder->refund($params);
...
| 交易金额         | txnAmt      | N1..12         | 无     | M-必填       | 与原始预授权完成交易一致                                     |
| 交易类型         | txnType     | N2             | 无     | M-必填       | 取值：33                                                     |
...
| 原交易查询流水号 | origQryId   | AN21           | 无     | M-必填       | 原始预授权完成交易的queryId                                  |
